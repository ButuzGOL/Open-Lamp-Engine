...
<div id="statikform">
	<form action="#" method="post" id="formata">
		...
		{CAPTCHA}
        <p><input type="hidden" name="action_statik" value="submit" /></p>
		<p><input name="action_statik" type="image" src="{THEME}/images/acceptform.png" class="submit" value="submit" /></p>
	</form>
</div>
