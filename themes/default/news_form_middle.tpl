...
<div id="newsform">
	<form action="#" method="post" id="formata">
		<div class="menu">
			<img src="{THEME}/images/news_form1.png" alt="Новость" title="Новость" onclick="tab('news'); setFieldName('short_story');" /> 
		...
		{CAPTCHA}
        <p><input type="hidden" name="action_news" value="submit" /></p>
		<p><input name="action_news" type="image" src="{THEME}/images/acceptform.png" class="submit" value="submit" /></p>
	</form>
</div>
