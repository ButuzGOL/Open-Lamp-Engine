...
#header h2 {position:absolute; top:61px; left:74px; font-size:14px;}
#header p {position:absolute; top:5px; left:0px;}
...
.block {font-size:11px; padding: 0px 10px 10px 10px; width:200px;  
	margin:10px auto;
...
.block h4 {text-transform:uppercase; color:#d7722f; font-size:11px; font-weight:normal; padding:10px 0px 5px 0px;}
...
.comment .text {min-height:105px; padding:7px 0; font-size:11px;}
...
.stat .text {padding:25px 20px 5px 5px;}
...
#mconteiner {width:90%; margin: auto;}
#mconteiner .blo{vertical-align: top;}
</style>
</head>
<body>
...
<div id="mconteiner">
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td style="width:230px;" class="blo">{LEFT_BLOCKS}</td>
	        <td class="blo">
                {TOP_BLOCKS}
