        <div class="foot">
			...
			<select name="make" onchange="diss();">
				...
				<option value="1">Включить блоки</option>
				<option value="1_1">Выключить блоки</option>
				<option value="2">Расположить: Лево</option>
				<option value="2_1">Расположить: Право</option>
				<option value="2_2">Расположить: Верх</option>
				<option value="2_3">Расположить: Низ</option>
