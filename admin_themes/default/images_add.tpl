<div class="middle0">
	<h1><a href="?m=images"><img src="{THEME}/images/images.png" title="Картинки" alt="Картинки" /></a> {TITLEE}</h1>
	<div class="back"><a href="?m=images"><img src="{THEME}/images/back.png" title="Картинки" alt="Картинки" /></a></div>
	<div class="forma">
		{MESS}
		<div class="form">
			<form action="#" method="post" enctype="multipart/form-data">
				...
				<div class="polya">
					<p class="pleft" style="width:200px;">
						Картинка 
